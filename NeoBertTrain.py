...
# ---------------------------
class NeoBertFinetuner(nn.Module):
    def __init__(self, model_name, num_issue_labels, dropout_prob=0.1):
        ...
        """
        super(NeoBertFinetuner, self).__init__()
...
def main():
    ...
    # Initialize our NeoBERT finetuning model.
    model = NeoBertFinetuner('chandar-lab/NeoBERT', args.num_issue_labels)
    model.to(device)
